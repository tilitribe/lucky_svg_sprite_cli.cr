...
describe LuckySvgSpriteCli::Converter do
  describe "#convert" do
    ...
    it "strips unwanted top-level attributes" do
      ...
      SVG
      expected_output = <<-OUTPUT
      tag "symbol", fill: "none", height: "32", stroke: "1.5", viewBox: "0 0 24 24", width: "32" do
        tag "path", d: "M13 2L3 14 12 14 11 22 21 10 12 10 13 2z"
    ...
    it "strips any unwanted color attributes if required" do
      ...
      format = LuckySvgSpriteCli::Format.new(strip: %w[fill stroke])
    ...
    it "strips stroke-width if required" do
      ...
      format = LuckySvgSpriteCli::Format.new(strip: %w[stroke-width])
      test_output(input, expected_output, format)
    end
  end
  ...
  describe ".from_file" do
    it "converts svg from file" do
      expected_output = <<-OUTPUT
      tag "symbol", fill: "none", height: "32", id: "svg-my-set-github-icon", stroke_linecap: "round", stroke_linejoin: "round", stroke_width: "2", viewBox: "0 0 24 24", width: "32" do
      ...
      output = LuckySvgSpriteCli::Converter.from_file(
    ...
    it "can convert without color" do
      expected_output = <<-OUTPUT
      tag "symbol", height: "32", id: "svg-my-set-github-icon", stroke_linecap: "round", stroke_linejoin: "round", stroke_width: "2", viewBox: "0 0 24 24", width: "32" do
        tag "path", d: "M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"
      end
      OUTPUT
  ...
  describe ".id_for_icon" do
    it "converts a file path to an id string" do
      id = LuckySvgSpriteCli::Converter.id_for_icon("./icons/my_set/github.svg")
      id.should eq("svg-my-set-github-icon")
      id = LuckySvgSpriteCli::Converter.id_for_icon("./icons/MySet/BloodyMary.svg")
      id.should eq("svg-my-set-bloody-mary-icon")
      id = LuckySvgSpriteCli::Converter.id_for_icon("./icons/_messy-set/123-fab.red.svg")
      id.should eq("svg-messy-set-fab-red-icon")
      id = LuckySvgSpriteCli::Converter.id_for_icon("./icons/WIN_95/TCP_IP.SVG")
...
private def test_output(
  ...
  format : LuckySvgSpriteCli::Format = LuckySvgSpriteCli::Format.new
)
  output = LuckySvgSpriteCli::Converter.new(input, format).convert
  output.should eq_html(expected_output)
end
