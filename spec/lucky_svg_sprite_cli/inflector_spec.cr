...
describe LuckySvgSpriteCli::Inflector do
  describe ".dasherize" do
    it "converts a string to lowercase joined by dashes" do
      ...
      cases.each do |from, to|
        LuckySvgSpriteCli::Inflector.dasherize(from).should eq(to)
      end
    end
    ...
    it "converts a file path into a dasherized string" do
      ...
      cases.each do |from, to|
        LuckySvgSpriteCli::Inflector.dasherize(from, from_path: true).should eq(to)
      end
    end
  end
  ...
  describe ".classify" do
    it "converts a string to a class name" do
      ...
      cases.each do |from, to|
        LuckySvgSpriteCli::Inflector.classify(from).should eq(to)
      end
    end
    ...
    it "converts a file path into a class name" do
      ...
      cases.each do |from, to|
        LuckySvgSpriteCli::Inflector.classify(from, from_path: true).should eq(to)
      end
    end
  end
end
